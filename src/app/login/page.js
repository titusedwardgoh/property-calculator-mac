  ...
  return (
    <div className="min-h-screen w-full relative flex items-start justify-center px-4 py-16 lg:py-12">
      ...
      <motion.div
        ...
        className="relative z-10 bg-white/80 backdrop-blur-sm shadow-[0_10px_24px_rgba(15,23,42,0.12),-4px_-4px_14px_rgba(255,255,255,0.78)] rounded-3xl border border-white/60 w-full max-w-md md:max-w-xl p-8"
      >
        {/* Header */}
