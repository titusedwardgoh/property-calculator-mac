...
export default function LandingPage() {
    ...
    const handleGetStarted = () => {
        // Temporarily use same approach as WelcomePage - will update during migration
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            >
                                <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-2xl font-bold text-secondary mx-auto mb-4">
                                    {step.number}
                                </div>
