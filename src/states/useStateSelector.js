...
import { calculateACTStampDuty, calculateACTOffThePlanExemption, calculateACTPensionerConcession, calculateACTOwnerOccupierConcession, calculateUpfrontCosts as calculateACTUpfrontCosts } from './act/calculations.js';
...
export const useStateSelector = (selectedState) => {
  ...
  const stateFunctions = {
    ...
    calculateACTOwnerOccupierConcession: selectedState === 'ACT' ? calculateACTOwnerOccupierConcession : null,
